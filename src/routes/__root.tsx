  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Unfiltered" },
      {
        ...
        content:
          "Real Australian stats, peer stories and support links on substance use among teenagers.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Zilla+Slab:wght@500;600;700&family=Source+Sans+3:wght@400;600;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
